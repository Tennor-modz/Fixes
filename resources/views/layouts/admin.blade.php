...
<html>
    <head>
        ...
        <title>{{ config('app.name', 'Drex Hosting') }} - @yield('title')</title>
            ...
            <aside class="main-sidebar">
                <section class="sidebar">
                    <ul class="sidebar-menu">
                        ...
                        <li class="{{ ! starts_with(Route::currentRouteName(), 'admin.coins') ?: 'active' }}">
                            <a href="{{ route('admin.coins') }}">
                                <i class="fa fa-diamond"></i> <span>Coin Requests</span>
                            </a>
                        </li>
