...
Route::get('/coins', [Admin\UserController::class, 'coinRequests'])->name('admin.coins');
Route::post('/coins/{request}/approve', [Admin\UserController::class, 'approveCoinRequest'])->name('admin.coins.approve');
Route::post('/coins/{request}/deny', [Admin\UserController::class, 'denyCoinRequest'])->name('admin.coins.deny');
